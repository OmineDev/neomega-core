...
const (
	S_mc_server_disconnect                                                                      = "mc server disconnect client"
	...
	S_cannot_connect_to_auth_server                                                             = "cannot connect to auth server"
	...
	S_auth_server_name_liliya                                                                   = "Liliya233 Auth Server"
	S_auth_server_name_liliya_direct                                                            = "Liliya233 Auth Server (Direct)"
	S_invalid_selection_please_select_in_range                                                  = "invalid input, please input in 1 ~ %v"
...
var I18nDict_zh_cn map[string]string = map[string]string{
	S_mc_server_disconnect:                                                "租赁服主动断开了和 neOmega 的连接",
	...
	S_auth_server_name_liliya:                                             "咕咕酱验证服务器",
	S_auth_server_name_liliya_direct:                                      "咕咕酱验证服务器 (直连)",
	S_invalid_selection_please_select_in_range:                            "无效的输入，请输入 1 ~ %v 间的选择",
	...
	S_cannot_connect_to_auth_server:                                       "无法连接到验证服务器",
	...
	S_bot_is_sending_cmd_at_a_very_high_ratio_could_cause_stability_issue: "机器人正在以极高的速度发送命令 (%.2f 命令每秒) 这可能会造成稳定性问题",
